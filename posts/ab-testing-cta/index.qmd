...
date: "2025-04-15"
description: "A simulation-based walkthrough of A/B testing through the lens of classical frequentist statistics — covering the Law of Large Numbers, bootstrap, CLT, hypothesis testing, regression equivalence, and the peeking problem."
categories: [statistics, python, A/B testing, data science]
image: "../../assets/ab-test-preview.png"
format:
  html:
    toc: true
    toc-depth: 2
